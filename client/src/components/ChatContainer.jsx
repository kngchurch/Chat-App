...
export default function ChatContainer(props) {
  ...
  // ✨ CHANGES MADE HERE: Updated handleSend to handle both group and normal chats
  const handleSend = async (msg) => {
    ...
    if (props.isGroupChat) {
      ...
      await axios.post(addGroupMessageRoute, {
        from: user._id,
        groupId: props.currentChat._id, // Note: groupId
        message: msg,
      });

      props.socket.current.emit("send-group-msg", {
        groupId: props.currentChat._id,
        from: user._id,
        message: msg,
      });
    } else {
      // If it's a normal one-to-one chat
